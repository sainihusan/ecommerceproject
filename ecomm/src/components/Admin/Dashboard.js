    ...
    formDataToSend.append("propertyImg", formData.propertyImg);
        ...
        try {
            if (isEdit) {
                ...
                await axios.put(`http://localhost:9000/property/update/${formData.id}`, formDataToSend);
            } else {

                await axios.post('http://localhost:9000/property', formDataToSend);
            ...
            <Dialog open={open} onClose={handleClose}>
                <form onSubmit={handleSubmit}>
                    ...
                    <DialogContent>
                        ...
                        <TextField label="Features" fullWidth name="features" value={formData.features || ''} onChange={handleFormChange} style={{ marginBottom: '10px' }} />
